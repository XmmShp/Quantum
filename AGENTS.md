...
- When adding, removing, or changing a public capability in either `../Quantum.Sdk/dotnet` or `../Quantum.Sdk/typescript`, inspect the other SDK and its Host adapter in the same change.
